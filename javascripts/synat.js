<?php $title = "So You Need a Typeface 2.0 - Interactive Type Finder"; ?>

<?php function show_head() { ?>
	
<?php } ?>

<?php function show_content() { ?>
	<?php for ($i = 0; $i < 11; $i++) { ?>
		<div id="level<?php echo $i; ?>" class="level span-24"></div>
	<?php } ?>
	
	<div class="span-3">&nbsp;</div>
	<div id="fonts" class="span-18"></div>
<?php } ?>

<?php function show_js() { ?>
	<script type="text/javascript" src="http://ajax.googleapis.com/ajax/libs/jquery/1.4.2/jquery.min.js"></script>
	<script type="text/javascript" src="javascripts/jquery.scrollTo-1.4.2-min.js"></script>
	<script type="text/javascript" src="javascripts/jquery.history.min.js"></script>
